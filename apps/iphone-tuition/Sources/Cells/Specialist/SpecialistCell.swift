...
public final class SpecialistCell: UICollectionViewCell {
  ...
  public var specialistName: String {
    ...
    get {
      return specialistView.fullName
    }
  }
...
extension SpecialistCell {
  public func bindViewModel(model: SpecialistViewModel) {
    specialistView.position = model.position ?? ""
    specialistView.avatarURL = model.photoUrl
    phoneNumber = model.phone ?? ""
    specialistID = model.id
    specialistName = model.fio
    isChatAvaliable = model.isChatAvailable()
