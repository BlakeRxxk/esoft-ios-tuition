...
public final class AuthCityCell: UICollectionViewCell {
  private static let reuseIdentifier: String = "AuthCityCellID"
  ...
  private(set) lazy var cityView: AuthCityView = AuthCityView()
  ...
  public weak var output: AuthCityCellOutput?
...
extension AuthCityCell: AuthCityCellInput {}
