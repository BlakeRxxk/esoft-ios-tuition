...
public protocol SellerTicketSectionControllerOutput: class {
  ...
  func didTapPhone(in cell: SellerTicketCellInput)
  func didTapChat(in cell: SellerTicketCellInput)
}
...
extension SellerTicketSectionController: SellerTicketCellOutput {
  public func didTapChat(in cell: SellerTicketCellInput) {
    output?.didTapChat(in: cell)
  }
  
  public func didTapPhone(in cell: SellerTicketCellInput) {
    output?.didTapPhone(in: cell)
  }
  
  public func didTapSpecialist(in cell: SellerTicketCellInput) {
