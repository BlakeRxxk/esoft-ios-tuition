...
//
//class NetworkAPITokenAuthenticatorTests: XCTestCase {
//  override func setUp() {
//    super.setUp()
...
//  }
//  
//  private let authenticator = NetworkAPITokenAuthenticator(tokenHeaderName: "tokenHeaderName",
...
//    let session = URLSessionMock.create(Resources.json)
//    let authenticator = NetworkAPITokenAuthenticator(tokenHeaderName: "tokenHeaderName",
//                                                      getCurrentToken: { nil },
//                                                      renewToken: { Single.just("renewToken") })
//    do {
...
//    let authenticator = NetworkAPITokenAuthenticator(tokenHeaderName: "tokenHeaderName",
//                                                      getCurrentToken: { "getCurrentToken" },
//                                                      renewToken: { Single.error(NetworkAPIError.unknown) })
//    
//    let response = authenticator.authenticate(session: session.rx,
//                                              request: Resources.urlRequest,
//                                              response: Resources.httpUrlResponse(code: 401)!,
...
//    
//    sut.authenticator = NetworkAPITokenAuthenticator(tokenHeaderName: tokenHeaderName,
