//
//  ListBindingSectionControllerSwiftWrapper.swift
//  ListKit
//
...
open class ListBindingSectionControllerSwiftWrapper<Object: ListDiffable, ViewModel: BindableViewModelType>: ListBindingSectionController<ListDiffable>,
ListBindingSectionControllerDataSource {
  ...
  public final func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>,
  ...
  public final func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>,
    ...
    guard let viewModel = viewModel as? ListDiffable else { fatalError("cannot cast viewModel to ListDiffable") }
