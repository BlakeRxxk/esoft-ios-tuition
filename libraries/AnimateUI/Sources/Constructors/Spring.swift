 ...
 */
@discardableResult public func spring(_ view: UIView,
...
/**
 ...
 - Returns: A series of ingredients that you can configure with all the animatable properties.
 */
@discardableResult public func spring(_ firstView: UIView,
                                      _ secondView: UIView,
                                      delay: TimeInterval = 0,
                                      spring: CGFloat,
                                      friction: CGFloat,
...
@discardableResult private func constructor(_ views: [UIView],
                                            _ delay: TimeInterval,
                                            _ spring: CGFloat,
                                            _ friction: CGFloat,
                                            _ mass: CGFloat,
                                            _ tolerance: CGFloat,
                                            _ calculation: Animation.Spring) -> (ingredients: [Ingredient], distillery: Distillery) {
