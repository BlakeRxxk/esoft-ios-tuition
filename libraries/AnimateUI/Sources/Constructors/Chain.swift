...
extension Distillery {
  ...
  /**
   ...
   - Returns: A series of ingredients that you can configure with all the animatable properties.
   */
  @discardableResult public func chains(delay: TimeInterval = 0,
                                        duration: TimeInterval = 0.5,
                                        curve: Animation.Curve = .linear,
                                        options: [Animation.Options] = [],
  ...
  /**
   ...
   - Returns: A series of ingredients that you can configure with all the animatable properties.
   */
  @discardableResult public func chainTwo(delay: TimeInterval = 0,
                                          duration: TimeInterval = 0.5,
                                          curve: Animation.Curve = .linear,
                                          options: [Animation.Options] = [],
  ...
  /**
   ...
   - Returns: A series of ingredients that you can configure with all the animatable properties.
   */
  @discardableResult public func chainsTwo(delay: TimeInterval = 0,
                                           duration: TimeInterval = 0.5,
                                           curve: Animation.Curve = .linear,
                                           options: [Animation.Options] = [],
  ...
  fileprivate func bezier(_ value: Int,
                          _ delay: TimeInterval,
                          _ duration: TimeInterval,
                          _ curve: Animation.Curve,
                          _ options: [Animation.Options]) -> [Ingredient] {
  ...
  fileprivate func constructor(_ value: Int,
                               delay: TimeInterval,
                               _ spring: CGFloat,
                               _ friction: CGFloat,
                               mass: CGFloat,
                               tolerance: CGFloat,
                               _ calculation: Animation.Spring) -> [Ingredient] {
