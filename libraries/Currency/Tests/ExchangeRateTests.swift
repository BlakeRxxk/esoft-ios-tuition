...
final class ExchangeRateTests: XCTestCase {
  ...
  func testInverseRate() {
    let exchangeRate: ExchangeRate = ExchangeRate(from: .USD, to: .EUR, rate: 0.93)
  ...
  func testEquatableRate() {
    let exchangeRate1: ExchangeRate = ExchangeRate(from: .USD, to: .EUR, rate: 0.93)
    let exchangeRate2: ExchangeRate = ExchangeRate(from: .USD, to: .EUR, rate: 0.93)
    let exchangeRate3: ExchangeRate = ExchangeRate(from: .USD, to: .EUR, rate: 0.94)
