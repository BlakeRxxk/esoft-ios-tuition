...
public final class SpecialistsUseCaseImplementation {
  private var specialistRepository: LoyaltyRepository
  
  public init(specialistRepository: LoyaltyRepository) {
    self.specialistRepository = specialistRepository
  }
}

extension SpecialistsUseCaseImplementation: SpecialistsUseCase {
  public func invoke(request: LoyaltyRequest) -> Observable<([Specialist], pages: Int)> {
