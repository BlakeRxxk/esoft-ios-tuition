...
extension Array {
  ...
  func mapToSpecialistsDetailsSections() -> [SpecialistDetailsSections] {
    map { obj -> SpecialistDetailsSections in
      switch obj {
      case is SpecialistViewModel:
        return .details(obj as! SpecialistViewModel)
      case is SpecialistDetailsActionViewModel:
        return .detailsActions(obj as! SpecialistDetailsActionViewModel)
      default:
        return .empty(EmptyListViewModel(title: "", message: "", image: UIImage()))
      }
    }
