...
final public class EditSellerPriceController: ViewController<BaseListView> {
  ...
  public override func viewDidLoad() {
    ...
    navigationItem.title = Localized.changePrice
  }
...
extension EditSellerPriceController {
  enum Localized {
    public static let search = "search".localize()
    public static let close = "Закрыть"
    public static let changePrice = "Изменить цену"
  }
}
